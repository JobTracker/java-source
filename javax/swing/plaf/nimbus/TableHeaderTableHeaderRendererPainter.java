...
public final class TableHeaderTableHeaderRendererPainter extends AbstractRegionPainter {
    ...
    public TableHeaderTableHeaderRendererPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
