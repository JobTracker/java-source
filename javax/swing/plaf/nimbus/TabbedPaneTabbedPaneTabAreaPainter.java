...
public final class TabbedPaneTabbedPaneTabAreaPainter extends AbstractRegionPainter {
    ...
    public TabbedPaneTabbedPaneTabAreaPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
